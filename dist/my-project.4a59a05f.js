...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener("hashchange", showRecipes);
 // window.addEventListener("load", showRecipes);
var _modelJs = require("./model.js");
var _configJs = require("./config.js");
var _recipeViewJs = require("./view/recipeView.js"); //parcel 2
...
var _bookmarksJs = require("./view/bookmarks.js");
...
const controlRecipes = async function() {
    try {
        ...
        (0, _bookmarksJsDefault.default).update(_modelJs.states.bookmarks);
        // 0 update result view to mark selected searach result
        //1  loading recipe
        await _modelJs.loadRecipes(id);
        // const { recipe } = model.states;
        // rending recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.states.recipe);
...
const controlBtnPagination = function(gotoBtnPage) {
    ...
    (0, _resultViewJsDefault.default).render(_modelJs.getSearchResultsPage(gotoBtnPage));
    // render new pagination
    (0, _paginationViewJsDefault.default).render(_modelJs.states.search);
};
const controlUpdateRecipe = function(newServings) {
    // update the recipe serving (state)
    _modelJs.updateRecipeServings(newServings);
    // recipeView.render(model.states.recipe);
    (0, _recipeViewJsDefault.default).update(_modelJs.states.recipe);
    // update the recipe VIEW
    BookmarkView.render(_modelJs.states.bookmarks);
};
const controlAddBookmarks = function() {
    if (!_modelJs.states.recipe.bookmarked) _modelJs.addBookmark(_modelJs.states.recipe);
    else _modelJs.deleteBookmark(_modelJs.states.recipe.id);
    (0, _recipeViewJsDefault.default).update(_modelJs.states.recipe);
    (0, _bookmarksJsDefault.default).render(_modelJs.states.bookmarks);
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        console.log(_modelJs.states.recipe);
        // render recipe
        (0, _recipeViewJsDefault.default).render(_modelJs.states.recipe);
        ...
        (0, _bookmarksJsDefault.default).render(_modelJs.states.bookmarks);
        // change ID in URL
        window.history.pushState(null, "", `#${_modelJs.states.recipe.id}`);
        // window.history.back();
        // close form window
        setTimeout(function() {
            (0, _addRecipeViewJsDefault.default)._toggleWindow();
        }, (0, _configJs.MODAL_CLOSE_SECS) * 1000);
    } catch (err) {
...
const init = function() {
    (0, _bookmarksJsDefault.default).addhandlerRender(controlBookmarks);
    (0, _recipeViewJsDefault.default).addHandleRender(controlRecipes);
    (0, _recipeViewJsDefault.default).addHandlerUpdateServings(controlUpdateRecipe);
    (0, _recipeViewJsDefault.default).addhandlerBookMarks(controlAddBookmarks);
    (0, _searchViewJsDefault.default).addSubmitSearch(controlsearchRe);
    (0, _paginationViewJsDefault.default).addhandlerClick(controlBtnPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./config.js":"2hPh4","./view/recipeView.js":"7jYBF","./view/searchView.js":"joADT","./view/resultView.js":"1zend","./view/bookmarks.js":"hbz9D","./view/addRecipeView.js":"brqkw","./view/paginationView.js":"f2E9A","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "loadSearchRe", ()=>loadSearchRe);
...
const loadRecipes = async function(id) {
    try {
        const data = await (0, _helpersJs.AJAXREQ)(`${(0, _configJs.API_URL)}/${id}?key=${(0, _configJs.KEY)}`);
        states.recipe = createRecipeObj(data);
        if (states.bookmarks.some((bookmark)=>bookmark.id === id)) states.recipe.bookmarked = true;
...
const loadSearchRe = async function(query) {
    try {
        states.search.query = query;
        const data = await (0, _helpersJs.AJAXREQ)(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.KEY)}`);
        console.log(data);
...
const getSearchResultsPage = function(page = states.search.page) {
...
const updateRecipeServings = function(newServings) {
    states.recipe.ingredients.forEach((ingredient)=>{
        ingredient.quantity = ingredient.quantity * newServings / states.recipe.servings;
...
const controlAddBookmarks = function() {
    ...
    if (!model.states.recipe.bookmarked) model.addBookmarks(model.states.recipe);
    else model.deleteBookmark(model.states.recipe.id);
...
const init = function() {
    ...
    if (storages) states.bookmarks = JSON.parse(storages);
};
init();
...
const upLoadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helpersJs.AJAXREQ)(`${(0, _configJs.API_URL)}?key=${(0, _configJs.KEY)}`, recipe);
        states.recipe = createRecipeObj(data);
        // add bookmark
...
},{"regenerator-runtime/runtime":"f6ot0","./config.js":"2hPh4","./helpers.js":"7nL9P","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "MODAL_CLOSE_SECS", ()=>MODAL_CLOSE_SECS);
const API_URL = "https://forkify-api.jonas.io/api/v2/recipes/";
const TIME_SEC = 10;
const RES_PER_PAGE = 10;
const KEY = "b1cc9275-6fd5-4103-b5a8-b6d06eb0ab16";
const MODAL_CLOSE_SECS = 2.5;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AJAXREQ", ()=>AJAXREQ);
...
const AJAXREQ = async function(URL, UploadData) {
    try {
        const fetchP = UploadData ? fetch(URL, {
            method: "POST",
            headers: {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
...
class RecipeView extends (0, _viewsJsDefault.default) {
    ...
    _errorMessage = "we could not find that recipe. please try again. by ariel pogi";
    _message = "";
    // handler render
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            const updateTo = +btnUpdateServings.dataset.updateTo;
    ...
    addhandlerBookMarks(handler) {
        this._parentElement.addEventListener("click", function(e) {
            const btnBokkMarks = e.target.closest(".btn--bookmark");
            if (!btnBokkMarks) return;
            handler();
        });
    }
    // generates
    ...
    _generateMarkUping(ing) {
        return `<li class="recipe__ingredient">
            ...
            <div class="recipe__quantity">
               ${ing.quantity ? new (0, _fractionJsDefault.default)(ing.quantity).toFraction(true) : ""}</div>
...
},{"../view/Views.js":"cSzjk","url:../../img/icons.svg":"fd0vu","fraction.js":"md6n5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cSzjk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        newEl.forEach((el, i)=>{
            ...
            // UPDATE CHANGE TEXT
            if (!el.isEqualNode(curel) && el.firstChild?.nodeValue.trim() !== "") // console.log("🔥", el.firstChild.nodeValue.trim());
            curel.textContent = el.textContent;
            if (!el.isEqualNode(curel)) console.log(Array.from(el.attributes));
            Array.from(el.attributes).forEach((att)=>curel.setAttribute(att.name, att.value));
        });
    }
    // clear
    _clear() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1zend":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
},{"../view/Views.js":"cSzjk","./previewView.js":"lWbv4","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lWbv4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
},{"../view/Views.js":"cSzjk","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hbz9D":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
},{"../view/Views.js":"cSzjk","./previewView.js":"lWbv4","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"brqkw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
class AddRecipeView extends (0, _viewsJsDefault.default) {
    ...
    _message = "recipe was success upload mo ariel POGI";
...
},{"../view/Views.js":"cSzjk","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f2E9A":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewsJs = require("../view/Views.js");
var _viewsJsDefault = parcelHelpers.interopDefault(_viewsJs);
...
class PaginationView extends (0, _viewsJsDefault.default) {
    ...
    _generatesMarkUp() {
        ...
        if (currentpages === 1 && numberPages > 1) return `<button data-goto="${currentpages + 1}" class="btn--inline pagination__btn--next">
            <span>Pages ${currentpages + 1}</span>
            <svg class="search__icon">
              <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
            </svg>
          </button> `;
        if (currentpages === numberPages && numberPages > 1) return `<button data-goto="${currentpages - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
        ...
        // other pages
        if (currentpages < numberPages) return `<button data-goto="${currentpages - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
              <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
            </svg>
            <span>pages ${currentpages - 1}</span>
...
},{"../view/Views.js":"cSzjk","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire716c", {}, "./", "/")

//# sourceMappingURL=my-project.4a59a05f.js.map
